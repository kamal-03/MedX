...
public class MainActivity extends AppCompatActivity
    ...
    // this is the recycler view code
    ...
    private List<ItemObjects> getListItemData(){
        ...
        listViewItems.add(new ItemObjects("Pharmacy", R.drawable.pharmacy));
        listViewItems.add(new ItemObjects("Fire Brigade", R.drawable.fire));
        listViewItems.add(new ItemObjects("SOS", R.drawable.sos));
        listViewItems.add(new ItemObjects("Blood Bank", R.drawable.blood));
